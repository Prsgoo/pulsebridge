...
export class BackoffManager {
  ...
  getLastRateLimitAt(pluginId: string): number | undefined {
    return this.lastRateLimitAt.get(pluginId);
  }

  setLastRateLimitAt(pluginId: string, timestamp: number): void {
    this.lastRateLimitAt.set(pluginId, timestamp);
  }

  // ---------------------------------------------------------------------------
  // Integration degraded backoff
  // ---------------------------------------------------------------------------
